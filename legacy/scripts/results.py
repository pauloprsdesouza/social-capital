...
for metric in metrics:
    f_val, p_val = stats.f_oneway(
        mrr_values[mrr_values['algorithm'] == 'B1-SCSA_PLUS-SCSA_PLUS_V3'][metric],
        mrr_values[mrr_values['algorithm'] == 'CS-SCSA_PLUS-SCSA_PLUS_V3'][metric],
        mrr_values[mrr_values['algorithm'] == 'SC-SCSA_PLUS-SCSA_PLUS_V3'][metric],
        mrr_values[mrr_values['algorithm'] == 'SCSA-SCSA_PLUS-SCSA_PLUS_V3'][metric],
        mrr_values[mrr_values['algorithm'] == 'B1-STATE_ART-SCSA_PLUS_V3'][metric],
        mrr_values[mrr_values['algorithm'] == 'CS-STATE_ART-SCSA_PLUS_V3'][metric],
        mrr_values[mrr_values['algorithm'] == 'SC-STATE_ART-SCSA_PLUS_V3'][metric],
        mrr_values[mrr_values['algorithm'] == 'SCSA-STATE_ART-SCSA_PLUS_V3'][metric]
    )
