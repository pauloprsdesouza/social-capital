...
def build_standalone_scsa_plus(
    ...
    *,
    ...
    for _, user_ratings in ratings.groupby("user_id", sort=False):
        ...
        rec = rerank_by_score(trial_ids, features, "scsa_plus_score", top_k=top_k)
...
def build_v3_recommendations(
    ...
    parts = [
        build_base_algorithm_trials(ratings),
        combined,
        build_standalone_scsa_plus(ratings, features, top_k=cfg.evaluation.ndcg_k),
    ]
